...
function App() {
  ...
  return (
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          <Route path="/" element={withProtectedLayout(<ResourceListPage />)} />
          ...
          <Route path="/admin" element={withProtectedLayout(<AdminDashboardPage />)} />
          <Route path="/admin/resources" element={withProtectedLayout(<AdminResourcesPage />)} />
          <Route path="/admin/bookings" element={withProtectedLayout(<AdminBookingsPage />)} />
