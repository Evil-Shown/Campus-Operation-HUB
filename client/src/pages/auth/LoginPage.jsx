        ...
        <div className="w-full lg:w-[45%] flex flex-col justify-between p-10 lg:p-16 h-screen lg:sticky lg:top-0" style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          <div
            style={{
              position: 'absolute',
              inset: 0,
              backgroundImage: `url('https://images.unsplash.com/photo-1627556704302-624286467c65?w=900&q=80')`,
          ...
          <div
            style={{
              position: 'absolute',
              inset: 0,
              background: 'linear-gradient(135deg, rgba(30,27,75,0.72) 0%, rgba(49,46,129,0.68) 100%)',
              zIndex: 1,
            }}
          />
          ...
          <style>{`
            @keyframes kenburns {
              ...
              100% { transform: scale(1.10) translateX(-25px); }
            }
          `}</style>
          ...
          <div style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%' }}>
            <div className="max-w-md">
              {/* Logo Row */}
              <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="flex items-center gap-4">
              ...
              {/* Headline */}
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="mt-16 sm:mt-24">
              ...
              <div className="mt-12 lg:mt-16 flex flex-col gap-8">
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.5 }} className="flex items-start gap-4">
                  <div className="w-9 h-9 rounded-lg bg-white/10 border border-white/20 backdrop-blur-sm flex items-center justify-center flex-shrink-0">
                    <Calendar className="text-white" size={18} />
                  </div>
                  <div>
                    <h3 className="text-sm font-semibold" style={{ color: 'white' }}>Book resources</h3>
                    <p className="text-sm mt-0.5" style={{ color: 'rgba(199,210,254,0.9)' }}>Rooms, labs, equipment and more</p>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.65 }} className="flex items-start gap-4">
                  <div className="w-9 h-9 rounded-lg bg-white/10 border border-white/20 backdrop-blur-sm flex items-center justify-center flex-shrink-0">
                    <AlertCircle className="text-white" size={18} />
                  </div>
                  <div>
                    <h3 className="text-sm font-semibold" style={{ color: 'white' }}>Report issues</h3>
                    <p className="text-sm mt-0.5" style={{ color: 'rgba(199,210,254,0.9)' }}>Submit and track maintenance tickets</p>
                  </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.8 }} className="flex items-start gap-4">
                  <div className="w-9 h-9 rounded-lg bg-white/10 border border-white/20 backdrop-blur-sm flex items-center justify-center flex-shrink-0">
                    <Bell className="text-white" size={18} />
                  </div>
                  <div>
                    <h3 className="text-sm font-semibold" style={{ color: 'white' }}>Stay updated</h3>
                    <p className="text-sm mt-0.5" style={{ color: 'rgba(199,210,254,0.9)' }}>Get notified on booking approvals and ticket updates</p>
                  </div>
                </motion.div>
              </div>
            </div>
            ...
            {/* Footer */}
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 1.0 }} className="mt-12 text-xs font-medium" style={{ color: 'rgba(165,180,252,0.8)' }}>
