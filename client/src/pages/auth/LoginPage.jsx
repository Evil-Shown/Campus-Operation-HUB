...
import { Mail, Lock, Eye, EyeOff, AlertCircle, School, ShieldCheck, ArrowRight, LayoutDashboard, Database, Zap, Fingerprint, Shield, Key } from 'lucide-react'
      ...
      <div className="relative z-10 w-full lg:w-[45%] flex flex-col justify-between p-8 lg:p-16">
        <div>
          ...
          <div className="max-w-xl">
            ...
            >
              Welcome back to <br />
              <span className="text-indigo-600 italic">The Hub</span>.
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }} 
              animate={{ opacity: 1, y: 0 }} 
            ...
            >
              Access your personalized operational workspace with end-to-end institutional security and real-time oversight.
            </motion.p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <FeatureCard 
                ...
                desc="Real-time visualization of institutional performance metrics."
                delay={0.4}
              />
              <FeatureCard 
                icon={Shield} 
                title="Secure Vault" 
                desc="Enterprise-grade protection for sensitive campus assets."
                delay={0.5}
              />
            </div>
          </div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} className="mt-12 text-sm text-slate-400 font-medium">
          &copy; 2026 SmartCampus Network &bull; SLIIT Faculty of Computing &bull; V2.0
        </motion.div>
      </div>
        ...
        >
          <div className="bg-white p-10 lg:p-14 rounded-[3rem] shadow-[0_30px_70px_rgba(0,0,0,0.06)] border border-slate-200/50 relative overflow-hidden">
             ...
             <div className="mb-10 text-center lg:text-left">
               ...
               <p className="text-slate-500 font-medium text-lg">Access your secure institutional portal.</p>
             </div>
             ...
             <form onSubmit={handleSubmit} className="space-y-6">
                <AnimatePresence>
                  {sessionExpired && (
                    <motion.div
                      ...
                      className="flex items-center gap-3 p-4 rounded-2xl bg-amber-50 border border-amber-200 text-amber-800 text-sm font-bold"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className={`w-full pl-14 pr-5 h-16 bg-slate-50 border border-slate-200 rounded-[1.5rem] text-slate-900 placeholder:text-slate-400 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none font-medium ${validationErrors.email ? 'border-rose-500 ring-rose-500/10' : ''}`}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center px-1">
                    <label className="text-xs font-bold uppercase tracking-widest text-slate-400">Security Phrase</label>
                    <a href="#" className="text-xs font-black text-indigo-600 hover:text-indigo-700 transition-colors uppercase tracking-widest">Forgot?</a>
                  </div>
                  <div className="relative group">
                ...
                {error && (
                  <motion.div
                    ...
                    className="p-4 rounded-2xl bg-rose-50 border border-rose-100 text-rose-700 text-sm font-bold flex items-center gap-3"
                  >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full h-16 bg-indigo-600 hover:bg-indigo-700 text-white rounded-[1.5rem] font-bold text-lg shadow-[0_15px_30px_rgba(79,70,229,0.2)] transition-all active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none flex items-center justify-center gap-2 group mt-4 relative overflow-hidden"
                >
             ...
             <div className="relative my-10">
                ...
                <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest text-slate-400">
                  <span className="bg-white px-4">Federated Identity</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                <a
                  ...
                  className="flex items-center justify-center gap-3 w-full h-16 bg-white border border-slate-200 rounded-[1.5rem] text-slate-700 font-bold text-sm hover:bg-slate-50 hover:border-slate-300 transition-all active:scale-[0.98] shadow-sm group"
                >
                  ...
                  <span className="group-hover:text-slate-900 transition-colors">Continue with Google SSO</span>
                </a>
              </div>
              ...
              <div className="mt-12 text-center">
                <p className="text-slate-500 font-medium">
                  New to SmartCampus?{' '}
                  <Link to="/signup" className="text-indigo-600 font-bold hover:underline underline-offset-4 decoration-2">Create an account</Link>
                </p>
              </div>
          </div>
          ...
          >
            <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest flex items-center justify-center gap-2">
              ...
              Secured by Institutional SSO & Cryptographic Protocols
            </p>
          </motion.div>
        </motion.div>
      </div>
