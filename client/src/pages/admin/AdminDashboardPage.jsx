...
export default function AdminDashboardPage() {
  ...
  const handleExportReport = async () => {
    try {
      ...
      const summaryRows = [
        { Section: 'Report', Metric: 'Generated At', Value: generatedAt.toLocaleString() },
      ...
      XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(analyticsRows), 'KPI Analytics')
      XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(resourcesRows), 'Resources')
      XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(bookingsRows), 'Bookings')
      XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(ticketsRows), 'Tickets')
      XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(usersRows), 'Users')
      XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(topUsersRows), 'Top Booking Users')
      XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(topResourcesRows), 'Top Resources')
      XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(utilizationRows), 'Utilization')
      XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(dailyActivityRows), 'Daily Activity')
