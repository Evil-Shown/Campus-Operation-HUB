        ...
        {links.map((link) => {
          ...
          return (
            <NavLink
              ...
              to={link.href}
              className={({ isActive }) =>
                `group relative flex items-center justify-between rounded-2xl px-4 py-3.5 text-xs font-black uppercase tracking-widest transition-all duration-300 border ${isActive
